...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav justify-content-between navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="keluar.php">Linnxw</a>
            <!-- Sidebar Toggle-->
...
<a href="export-keluar.php" class ="btn btn-info">Export data</a>
                     ...
                     <tbody>
               <?php 
                 $stock = mysqli_query($conn,"SELECT * FROM stock s, keluar k WHERE s.idbarang = k.idbarang");
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Edit barang keluar</h5>
      ...
      <div class="modal-body">
        <form action="" method="post" class="d-flex gap-3 flex-column">
         <div class="form-floating mb-3">
           ...
           name="penerima" value='<?=$data["penerima"]?>'
           required/>
         ...
         <div class="form-floating mb-3">
          ...
          <button type="submit" class="btn btn-primary" name="editkeluar">Edit</button>
        </form>
      </div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="staticBackdropLabel">Hapus Barang keluar</h5>
        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
      </div>
      ...
      <div class="modal-footer">
        ...
        <input type="hidden" name="qty" value='<?=$data["qty"]?>'>
         <button type="submit" class="btn btn-danger" data-bs-dismiss="modal" name="deletekeluar">Ya,saya yakin</button>
        </form>
